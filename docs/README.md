# code-server fork for dcflight

A use case is component previews and  integrated dev tools directly into a dedicated ide in the web from just  installing dcflight 
